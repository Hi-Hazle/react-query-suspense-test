  ...
  return (
    <>
      <Suspense fallback={<Typography variant="h1">LOADING</Typography>}>
        ...
        <Suspense fallback={<Typography variant="h1">LOADING2</Typography>}>
...
const DataWrapper1 = ({ startTime }: { startTime: Date }) => {
  ...
  return (
    <>
      <Typography variant="h2">DataWrapper1 Total Time : {takenTime}초</Typography>
      <DataComponent1 />
      <DataComponent2 />
    </>
  );
...
const DataWrapper2 = ({ startTime }: { startTime: Date }) => {
  ...
  return (
    <Box sx={{ marginTop: '100px' }}>
      <Typography variant="h2">DataWrapper2 Total Time : {takenTime}초</Typography>
      <DataComponent3 />
      <DataComponent4 />
    </Box>
  );
